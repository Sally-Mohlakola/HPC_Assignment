...
static inline RGBColorF ray_c(Ray r, const ObjectLL *world, int depth) {
...
static inline void randomSpheres(ObjectLL *world, DynamicStackAlloc *dsa) {
    ...
    for (int a = -11; a < 11; a++) {
        for (int b = -11; b < 11; b++) {
            CFLOAT chooseMat = util_randomFloat(0.0, 1.0);
            vec3 center = {.x = a + 0.9 * util_randomFloat(0.0, 1.0),
                           .y = 0.2,
                           .z = b + 0.9 * util_randomFloat(0.0, 1.0)};
            ...
            if (length > 0.9) {
                if (chooseMat < 0.8) {
                    RGBColorF albedo = {
                        .r = util_randomFloat(0.0, 1.0) * util_randomFloat(0.0, 1.0),
                        .g = util_randomFloat(0.0, 1.0) * util_randomFloat(0.0, 1.0),
                        .b = util_randomFloat(0.0, 1.0) * util_randomFloat(0.0, 1.0),
                    };
